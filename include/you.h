...
#define BODY_HUMAN 1
#define BODY_TRAVEL 2
#define BODY_SHIELD 3
#define BODY_BLADE 4
#define BODY_DIG 5
#define BODY_REST 6
#define BODY_CONSERVE 7
#define BODY_HIDE 8
#define BODY_MOVE_PHASE	1
#define BODY_MOVE_FLY	2
#define BODY_MOVE_WATER_WALK	3
...
struct Role {
	...
	long malenum, /* index (PM_) as a male (botl.c) */
...
struct Race {
	...
	/*** Indices of important monsters and objects ***/
	long malenum, /* PM_ as a male monster */
		femalenum, /* ...or as a female (NON_PM == same) */
...
struct you {
	...
	int bodyshapehold; /* body shape in progress */
	int bodyshape; /* body shape */
	int bodyhard; /* body hardness */
	int bodyswift; /* body swiftness */
	int bodyenergy; /* body energy */
	int bodymove; /* body move - phasing, flight, water walking, levitation */
	int tempdr; /* temporary damage reduction */
	int tempdruse; /* temporary damage reduction usage */
	int tempac; /* temporary AC boost */
	int tempacuse; /* temporary AC boost usage */
	int tempaccheck; /* last moves check on temporary AC boost usage */
	int tempspeed; /* temp speed */
	int tempspeeduse; /* temp speed usage */
	int tempenergy; /* temp energy */
	int tempenergytype; /* type of temp energy */
	int tempenergyuse; /* temp energy usage */
	int tempmove; /* temp move type */
	int tempmoveuse; /* temp move usage */
