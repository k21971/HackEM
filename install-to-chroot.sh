...
NHSUBDIR="hackem-1.3.1"
# VAR_PLAYGROUND from include/unixconf.h
NH_VAR_PLAYGROUND="/hackem-1.3.1/var/"
# END OF CONFIG
##############################################################################
...
mkdir -p "$NAO_CHROOT/dgldir/inprogress-hackem131"
chown "$USRGRP" "$NAO_CHROOT/dgldir/inprogress-hackem131"
