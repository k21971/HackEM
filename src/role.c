...
const struct Role roles[] = {
    ...
    { { "Barbarian", 0 },
      ...
      S_TROLL,
      ART_RING_OF_P_HUL,
      MH_HUMAN | MH_CENTAUR | MH_DWARF | MH_GIANT | MH_ORC | MH_TORTLE | MH_VAMPIRE | MH_ZOMBIE,
    ...
    { { "Convict", 0 },
      ...
      MH_HUMAN | MH_CENTAUR | MH_DWARF | MH_GIANT | MH_GNOME | MH_HOBBIT | MH_ILLITHID | MH_ORC | MH_SHIFTER | MH_VAMPIRE | MH_ZOMBIE,
    ...
    { { "Flame Mage", 0 }, 
      ...
      MH_HUMAN | MH_DWARF | MH_ELF | MH_GNOME | MH_GIANT | MH_SHIFTER,
      ROLE_MALE | ROLE_FEMALE | ROLE_LAWFUL | ROLE_NEUTRAL,
      /* Str Int Wis Dex Con Cha */
      {   7, 9,  11,  7,  7,  7 },
      {  12, 15, 20, 20, 20, 10 },
    ...
    { { "Ice Mage", 0 }, 
      ...
      S_XORN,
      ART_STORM_WHISTLE,
      MH_HUMAN | MH_CENTAUR | MH_ORC | MH_ILLITHID | MH_VAMPIRE | MH_SHIFTER,
      ROLE_MALE | ROLE_FEMALE | ROLE_NEUTRAL | ROLE_CHAOTIC,
    ...
    { { "Infidel", 0 },
      ...
      S_UNICORN,
      ART_IDOL_OF_MOLOCH,
      MH_HUMAN | MH_CENTAUR | MH_GIANT | MH_ORC | MH_ILLITHID | MH_ZOMBIE,
    ...
    { { "Monk", 0 },
      ...
      MH_HUMAN | MH_CENTAUR | MH_DWARF | MH_ELF | MH_GIANT | MH_TORTLE | MH_SHIFTER | MH_ZOMBIE,
      ROLE_MALE | ROLE_FEMALE | ROLE_LAWFUL | ROLE_NEUTRAL
          | ROLE_CHAOTIC,
      /* Str Int Wis Dex Con Cha */
      { 10, 7, 14, 8, 7, 7 },
    ...
    { { "Necromancer", 0 }, 
      ...
      MH_HUMAN | MH_CENTAUR | MH_GIANT | MH_ILLITHID | MH_ORC | MH_VAMPIRE | MH_SHIFTER,
    ...
    { { "Priest", "Priestess" },
      ...
      MH_HUMAN | MH_CENTAUR | MH_DWARF | MH_ELF | MH_GIANT | MH_HOBBIT | MH_ILLITHID | MH_ORC | MH_TORTLE | MH_SHIFTER,
      ROLE_MALE | ROLE_FEMALE | ROLE_LAWFUL | ROLE_NEUTRAL
          | ROLE_CHAOTIC,
      /* Str Int Wis Dex Con Cha */
      {   7, 10, 10,  7,  7,  7 },
    ...
    { { "Pirate", 0 }, 
      ...
      MH_HUMAN | MH_GNOME | MH_ILLITHID | MH_ORC | MH_VAMPIRE | MH_SHIFTER,
      ROLE_MALE | ROLE_FEMALE | ROLE_NEUTRAL | ROLE_CHAOTIC,
      /* Str Int Wis Dex Con Cha */
      {   8,  7, 7,  8,  8,  7 },
      {  20, 15, 10, 20, 25, 10 },
    ...
    { { "Rogue", 0 },
      ...
      MH_HUMAN | MH_GNOME | MH_HOBBIT | MH_ORC | MH_SHIFTER | MH_VAMPIRE | MH_ZOMBIE,
      ROLE_MALE | ROLE_FEMALE | ROLE_NEUTRAL | ROLE_CHAOTIC,
      /* Str Int Wis Dex Con Cha */
      { 7, 7, 7, 10, 7, 6 },
      { 20, 10, 10, 30, 20, 10 },
    ...
    MH_HUMAN | MH_CENTAUR | MH_DWARF | MH_ELF |  MH_GNOME | MH_GIANT | MH_HOBBIT | MH_SHIFTER | MH_TORTLE | MH_VAMPIRE,
    ROLE_MALE | ROLE_FEMALE | ROLE_LAWFUL | ROLE_NEUTRAL,
...
const struct Race races[] = {
    ...
    },
	{
        ...
        MH_ZOMBIE,
        MH_ZOMBIE,
        MH_HUMAN | MH_ELF | MH_DWARF | MH_GNOME | MH_HOBBIT | MH_GIANT | MH_CENTAUR | MH_ORC | MH_TORTLE | MH_ILLITHID,
        /*  Str    Int Wis Dex Con Cha */
        { 3, 3, 3, 3, 3, 3 },
...
role_init()
{
    ...
    if (u.uevent.uhand_of_elbereth == 4 && !Race_if(PM_DRAUGR)) { /* crowned as a demon */
        urace = race_demon;
    ...
    if (alignmnt == A_CHAOTIC && Role_if(PM_KNIGHT) && !Race_if(PM_DRAUGR)) {
        urole = align_roles[0];
    }
